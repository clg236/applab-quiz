        ...
        <main className={classes.content}>
            ...
            <Card className={classes.card}>
                <CardContent>
                    ...
                    <CardActions>
                        <Button size="small" component={Link} to={ROUTES.ADMIN_CREATE_QUIZ}><FontAwesomeIcon icon="plus-square" size="lg" fixedWidth/>Create a Quiz</Button>
                    </CardActions>
            </Card>
            </Grid>
            <Grid item>
            <Card className={classes.card}>
                <CardContent>
                    ...
                    <CardActions>
                        <Button size="small" component={Link} to={ROUTES.ADMIN_CREATE_QUIZ}><FontAwesomeIcon icon="chart-line" size="lg" fixedWidth/>View Analytics</Button>
                    </CardActions>
            </Card>
            </Grid>
            </Grid>
